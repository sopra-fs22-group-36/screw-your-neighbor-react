...
*/
    ...
    let content = <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTF_oKbJzKbF3cywcrD2WlY4s1bs9x-TxgQilDVrwIhevomVZ8akEn2zKDURwuLb3xM0m8&usqp=CAU" alt="Lamp" width="32" height="32"></img> //placeholder
  ...
  return (
      <div className="div-box">
          ...
          <BaseContainer>
              <h3>
                Choose one of the Rooms to join
              </h3>
              {content}
          </BaseContainer>
